...
- **"Online Services"** means the online services We provide to You, including the Diode Network, Fleet Contracts and other Smart Contracts, Application and Device APIs, web services, and other Software for which We manage hosting, and that You access and manage settings for by using Account Credentials registered with the online service.
...
- **"We," " Us," or " Our"** means Diode, a Wyoming Corporation with a principal place of business at 30 N Gould St Ste 20452, Sheridan, WY 82801, United States of America, and third parties acting on our behalf.
