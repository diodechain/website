---
layout: post
title:  "Getting Started: Miners"
date: 2019-01-30 15:32
categories: [Guides]
tags: [Development, Security, Guides, Server Client]
image: img-01.jpg
---

This guide is the counterpiece to our device client guide that we posted a couple of days ago. If you're planning to run a device fleet click here. In this post we will step by step describe how to install and run the Diode AlphaNet Mining Software to either join the public network or run your own private development network.
