...
gulp.task('watch', function () {
    ...
    gulp.watch(['_config.yml', '*.html', '_includes/svgs/*', 'newsletter/*.html', 'download/*.html', 'status/*', 'testnet/*', 'testnet/*/*', '_includes/*.html', '_includes/*/*.html', '_layouts/*.html', '_layouts/*/*.html', '_docs/*', '_posts/*', '_drafts/*', 'js/*.js', 'images/*', 'blog/*'], ['jekyll-rebuild']);
});
