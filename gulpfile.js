...
gulp.task('watch', function () {
    ...
    gulp.watch(['_config.yml', '*.html', '_includes/svgs/*', 'newsletter/*.html', '_includes/*.html', '_includes/*/*.html', '_layouts/*.html', '_layouts/*/*.html', '_posts/*', '_drafts/*', 'js/*.js', 'images/*', 'blog/*'], ['jekyll-rebuild']);
});
