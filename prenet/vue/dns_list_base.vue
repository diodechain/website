<template id="dns_list_base">
  <div>
    <div class="title row">
      <div class="col-md-3 no-padding">
        <h1>Base Blockchain Name System v<% version %></h1>
      </div>
    </div>
...
<script>
var BDNSList = Vue.component("dns_list_base", {
  template: document.getElementById("dns_list_base").innerHTML,
  delimiters: ["<%", "%>"],
  data: () => {
    return {
      blocks: {},
  ...
  methods: {
    ...
    callDNS: async function (method, params) {
      ...
      let data = await this.web3.eth.call({
          to: "0x87C1D1304944a9EA16aF18CB777E3CeE0D3dACEa",
          data: call,
          gasPrice: 0
      })
